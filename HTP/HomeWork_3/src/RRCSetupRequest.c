...
static asn_TYPE_member_t asn_MBR_RRCSetupRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCSetupRequest, rrcSerupRequest),
...
static const asn_TYPE_tag2member_t asn_MAP_RRCSetupRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* rrcSerupRequest */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCSetupRequest_specs_1 = {
